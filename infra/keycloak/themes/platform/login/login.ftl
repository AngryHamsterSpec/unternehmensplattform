...
<#assign demoEnabled = (realm.attributes["publicDemoEnabled"]!"false") == "true">
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    <#if section = "header">
        ${msg("loginAccountTitle")}
    <#elseif section = "form">
        <#if demoEnabled>
            <aside class="recruiter-demo" aria-label="Öffentlicher Demo-Zugang">
                <span class="recruiter-demo__eyebrow">Recruiter Demo</span>
